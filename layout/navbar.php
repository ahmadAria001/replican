            ...
            <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small" id="main-nav">
                ...
                <li>
                    <div class="dd-lay">
                        ...
                        <ul class="dd-content">
                            <li class="dd-li"><a class="p-3" id="a-dd" href="#">Unit Pelayanan</a></li>
                            <li <?= $artc;?> class="dd-li"><a class="p-3" id="a-dd" href="../pages/article_input.php">Article Imput</a></li>
                        </ul>
                    </div>
                </li>
                <li>
                    <div class="dd-ttng">
                        ...
                        <ul class="ttng-ul">
                            <li><a class="p-3" href="">UKP</a></li>
                            <li><a class="p-3" href="">UKM</a></li>
                            <li><a class="p-3" href="">Profile</a></li>
                        </ul>
                    </div>
                </li>
                <li>
